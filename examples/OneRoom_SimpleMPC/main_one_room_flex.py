...
def run_example(until=until, with_plots=False):
    ...
    Change flex_power_feedback_method in MarketSpecifications to deal with systems with fast or slow inertia.
    See difference in results: when using collocation, power during flex event does not fully follow offer. When using constant it does. Reason is the fast inertia of the system.
