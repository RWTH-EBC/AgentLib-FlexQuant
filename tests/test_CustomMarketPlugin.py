...
def run_example_from_path(example_path: Path):
    ...
    """
    run_script_path = example_path / 'run_example.py'
...
def test_custommarketplugin(snapshot, module_cleanup):
    ...
    example_path = root_path / 'examples' / 'CustomMarketPlugin'
    ...
    assert_frame_matches_summary_snapshot(
        snapshot,
        df_neg_flex_res,
        'CustomMarketPlugin_neg_flex_summary.json'
    )
    assert_frame_matches_summary_snapshot(
        snapshot,
        df_pos_flex_res,
        'CustomMarketPlugin_pos_flex_summary.json'
    )
    assert_frame_matches_summary_snapshot(
        snapshot,
        df_baseline_res,
        'CustomMarketPlugin_baseline_summary.json'
    )
    assert_frame_matches_summary_snapshot(
        snapshot,
        df_indicator_res,
