...
class SimpleTestHallModelConfig(CasadiModelConfig):
    ...
    states: List[CasadiState] = [
        ...
        # algebraic
        CasadiState(name="Q_tabs_abs", value=0, unit="W", description=""),
        CasadiState(name="Q_ahu_abs", value=0, unit="W", description=""),

        CasadiState(name="Q_Ahu", value=5000, unit="W", description="Heat of ahu"),
        CasadiState(name="P_el", value=7000, unit="W", description="P_el"),
        CasadiState(name="q_ig_conv", value=7000, unit="W",
                    description="Internal gains (convective)"),
        CasadiState(name="q_Roof", value=7000, unit="W", description="Heat into zone through roof"),
        CasadiState(name="q_ExtWall", value=7000, unit="W",
                    description="Heat into zone through exterior wall"),
        CasadiState(name="q_IntWall", value=7000, unit="W",
                    description="Heat into zone through interior wall"),
        CasadiState(name="q_Win", value=7000, unit="W",
                    description="Heat into zone through window"),
        CasadiState(name="q_Floor", value=7000, unit="W",
                    description="Heat into zone through floor"),
        CasadiState(name="q_Tabs", value=0, unit="W", description="Heat into zone through TABS"),
        CasadiState(name="q_Ahu", value=7000, unit="W", description="Heat into zone through AHU"),
        CasadiState(name="Q_Tabs", value=0, unit="W", description="Heat from water to TABS"),
        CasadiState(name="Q_RadSol_air", value=0, unit="W",
                    description="Approximated solar radiation for air"),

        CasadiState(name="heat_roof", value=500, unit="W", description="Heatflow through roof"),
        CasadiState(name="heat_window", value=500, unit="W", description="Heatflow through window"),
        CasadiState(name="heat_extWall", value=500, unit="W",
                    description="Heatflow through extWall"),
        CasadiState(name="T_Win_outdoor", value=280, unit="K", description="Test"),
        # slack variables
    ...
    outputs: List[CasadiOutput] = [
        ...
        CasadiState(name="T_Win_sur", value=293.15, unit="K", description="Surface Temperature on the inside of the window"),
        CasadiState(name="T_ExtWall_sur", value=293.15, unit="K", description="Surface Temperature on the inside of the external wall"),
        CasadiState(name="T_IntWall_sur", value=293.15, unit="K", description="Surface Temperature on the inside of the internal wall"),
        CasadiState(name="T_Roof_sur", value=293.15, unit="K", description="Surface Temperature on the inside of the roof"),
        CasadiState(name="heat_humans_conv", value=500, unit="W", description="Convective internal gains heatflow from humans"),
        CasadiState(name="heat_humans_rad", value=500, unit="W", description="Radiative internal gains heatflow from humans"),
        CasadiState(name="heat_devices_conv", value=500, unit="W", description="Convective internal gains heatflow from devices"),
        CasadiState(name="heat_devices_rad", value=500, unit="W", description="Radiative internal gains heatflow from devices"),
        CasadiState(name="heat_lights_conv", value=500, unit="W", description="Convective internal gains heatflow from lights"),
        CasadiState(name="heat_lights_rad", value=500, unit="W", description="Radiative internal gains heatflow from lights"),
        CasadiState(name="Q_RadSol_ext_sol", value=500, unit="W", description="Radiative internal gains heatflow from lights"),
        CasadiState(name="Q_RadSol_int_sol", value=500, unit="W", description="Radiative internal gains heatflow from lights"),
        CasadiState(name="Q_RadSol_roof_sol", value=500, unit="W", description="Radiative internal gains heatflow from lights"),
    ]
