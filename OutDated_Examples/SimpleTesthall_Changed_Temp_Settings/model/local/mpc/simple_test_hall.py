...
class SimpleTestHallModelConfig(CasadiModelConfig):
    ...
    inputs: List[CasadiInput] = [
        ...
        CasadiInput(name="T_ahu_set", value=295, unit="K", description="Setpoint for ahu"),

        # disturbances
        CasadiInput(name="Q_RadSol", value=0, unit="W",
                    description="Radiative solar heat for all orientations"),
        CasadiInput(name="T_amb", value=295.15, unit="K",
                    description="Ambient temperature on the outside"),
        CasadiInput(name="T_preTemWin", value=295.15, unit="K",
                    description="Outdoor surface temperature of window"),
        CasadiInput(name="T_preTemWall", value=295.15, unit="K",
                    description="Outdoor surface temperature of wall"),
        CasadiInput(name="T_preTemRoof", value=295.15, unit="K",
    ...
    states: List[CasadiState] = [
        # differential
        CasadiState(name="T_Air", value=295.15, unit="K", description="Temperature of zone"),
        CasadiState(name="T_Roof", value=295.15, unit="K",
                    description="Temperature of roof in middle"),
        CasadiState(name="T_Floor", value=295.15, unit="K",
                    description="Temperature of floor in middle"),
        CasadiState(name="T_ExtWall", value=295.15, unit="K",
                    description="Outer wall temperature in middle"),
        CasadiState(name="T_IntWall", value=295.15, unit="K",
        ...
        CasadiState(name="T_Tabs", value=295.15, unit="K", description="TABS temperature"),
    ...
    parameters: List[CasadiParameter] = [
        ...
        CasadiParameter(name="s_T", value=4,
    ...
    outputs: List[CasadiOutput] = [
        ...
        CasadiOutput(name="T_Win_sur", value=295.15, unit="K",
                     description="Surface Temperature on the inside of the window"),
        CasadiOutput(name="T_ExtWall_sur", value=295.15, unit="K",
                     description="Surface Temperature on the inside of the external wall"),
        CasadiOutput(name="T_IntWall_sur", value=295.15, unit="K",
                     description="Surface Temperature on the inside of the internal wall"),
        CasadiOutput(name="T_Roof_sur", value=295.15, unit="K",
        ...
        CasadiOutput(name="objTemp", unit="-", description=""),
        CasadiOutput(name="objPel", unit="-", description=""),
        CasadiOutput(name="objTime", unit="-", description=""),
        CasadiOutput(name="objExt", unit="-", description=""),
    ]
...
class SimpleTestHall(CasadiModel):
    ...
    def setup_system(self):
        ...
        self.Q_RadSol_air.alg = (self.Q_RadSol / (self.gWin * (
        ...
        self.T_ExtWall_sur.alg = (
                coeff_dict['T_ext_sur']['T_Air'] * self.T_Air + coeff_dict['T_ext_sur']['T_ext'] * self.T_ExtWall +
                coeff_dict['T_ext_sur']['T_int'] * self.T_IntWall + coeff_dict['T_ext_sur'][
                    'T_roof'] * self.T_Roof +
                coeff_dict['T_ext_sur']['Q_RadSol'] * self.Q_RadSol + coeff_dict['T_ext_sur'][
                    'q_ig_rad'] * q_ig_rad +
                coeff_dict['T_ext_sur']['T_preTemWin'] * self.T_preTemWin)
        self.T_IntWall_sur.alg = (
                coeff_dict['T_int_sur']['T_Air'] * self.T_Air + coeff_dict['T_int_sur']['T_ext'] * self.T_ExtWall +
                coeff_dict['T_int_sur']['T_int'] * self.T_IntWall + coeff_dict['T_int_sur'][
                    'T_roof'] * self.T_Roof +
                coeff_dict['T_int_sur']['Q_RadSol'] * self.Q_RadSol + coeff_dict['T_int_sur'][
                    'q_ig_rad'] * q_ig_rad +
                coeff_dict['T_int_sur']['T_preTemWin'] * self.T_preTemWin)
        self.T_Roof_sur.alg = (coeff_dict['T_roof_sur']['T_Air'] * self.T_Air + coeff_dict['T_roof_sur'][
            'T_ext'] * self.T_ExtWall +
                               coeff_dict['T_roof_sur']['T_int'] * self.T_IntWall + coeff_dict['T_roof_sur'][
                                   'T_roof'] * self.T_Roof +
                               coeff_dict['T_roof_sur']['Q_RadSol'] * self.Q_RadSol + coeff_dict['T_roof_sur'][
                                   'q_ig_rad'] * q_ig_rad +
                               coeff_dict['T_roof_sur']['T_preTemWin'] * self.T_preTemWin)
        self.T_Win_sur.alg = (
                coeff_dict['T_win_sur']['T_Air'] * self.T_Air + coeff_dict['T_win_sur']['T_ext'] * self.T_ExtWall +
                coeff_dict['T_win_sur']['T_int'] * self.T_IntWall + coeff_dict['T_win_sur'][
                    'T_roof'] * self.T_Roof +
                coeff_dict['T_win_sur']['Q_RadSol'] * self.Q_RadSol + coeff_dict['T_win_sur'][
                    'q_ig_rad'] * q_ig_rad +
        ...
        # region Define ae
        self.Q_Ahu.alg = self.m_flow_ahu * self.air_cp * (
                self.T_ahu_set - (0.95 * self.T_Air + 1.05 * self.T_amb) / 2)  # heat recovery in AHU
        ...
        self.objTemp.alg = (self.s_T / (self.s_T + self.s_Pel))
        self.objPel.alg = (self.r_pel / 4) * (self.s_Pel / (self.s_T + self.s_Pel)) * self.P_el_c / 1000
        self.objTime.alg = (self.prediction_horizon * self.sample_time)

        try:
            self.objExt.alg = self.P_el_c - self._P_external
        except:
            self.objExt.alg = 0
        ...
        objective = sum(
            [
                ...
                self.r_pel * self.s_Pel * self.P_el_c / 1000,
            ]
