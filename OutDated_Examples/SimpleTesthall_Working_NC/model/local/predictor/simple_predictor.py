...
class PredictorModuleConfig(al.BaseModuleConfig):
    ...
    outputs: al.AgentVariables = [
        ...
        al.AgentVariable(
            name="r_pel_pred", unit="ct/kWh", description="Weight for P_el in objective function"
        ),
    ...
    parameters: al.AgentVariables = [
        ...
        al.AgentVariable(
            name="comfort_interval_start",
            value=7,
            description="Hour of day when stricter comfort starts",
        ),
        al.AgentVariable(
            name="comfort_interval_end",
            value=19,
        ...
        al.AgentVariable(
            ...
            value=2,
            description="const, for const signal. pandb, for base and peak signal, dyn, for varying signal",
        ),
        al.AgentVariable(
