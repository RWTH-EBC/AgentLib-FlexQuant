...
class SimpleTestHall(CasadiModel):
    ...
    def setup_system(self):
        ...
        self.P_el_c.alg = (self.Q_Ahu_abs + self.Q_tabs_abs) / self.COP  # (abs(Q_RLT) + abs(Q_BKT))
        ...
        self.objPel.alg = self.s_Pel * self.r_pel * self.P_el_c / 1000
        ...
        objective = sum(
            [
                ...
                self.s_Pel * self.r_pel * self.P_el_c / 1000,
            ]
